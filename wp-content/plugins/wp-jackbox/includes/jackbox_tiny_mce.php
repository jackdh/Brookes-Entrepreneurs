<?php
	...
	function add_jackbox_button($plugins) {
		...
		$plugins["jackbox"] = plugins_url("wp-jackbox/js/jackbox_tinymce.js");
	...
	function jackbox_localize() {
		...
		wp_localize_script("jackbox_admin_js", "jackboxTranslate", array(
			...
			"jb_3" => __("Category Name", "jackbox_domain"),
			"jb_4" => __("The category of your item (required for even a single item)", "jackbox_domain"),
